 ...
 *
 *         void mass(double u1, double p1, double p2, double p3, double p4, double y1[1], double y2[1])
 *
 *    Simulink version           : 9.2 (R2018b) 24-May-2018
 *    C source code generated on : 30-Nov-2018 15:33:20
 *
...
/**
     ...
     def.SFunctionName = 'mass';
     def.OutputFcnSpec = 'void mass(double u1, double p1, double p2, double p3, double p4, double y1[1], double y2[1])';
     def.HeaderFiles = {'massc.h'};
     def.SourceFiles = {'massc.cpp'};
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "mass", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
