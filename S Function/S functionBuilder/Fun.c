 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Nov 16 15:34:28 2018
 */
...
#define NPARAMS               4
/* Parameter 0 */
#define PARAMETER_0_NAME      K
#define PARAMETER_0_DTYPE     real_T
#define PARAMETER_0_COMPLEX   COMPLEX_NO
/* Parameter 1 */
#define PARAMETER_1_NAME      C
...
/* Parameter 3 */
#define PARAMETER_3_NAME      delta_t
...
#define SOURCEFILES           "__SFB__massc.cpp"
#define PANELINDEX            8
...
extern void Fun_Outputs_wrapper(const real_T *u1,
			real_T *y1,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *K = (const real_T *) mxGetData(PARAM_DEF0(S));
    const real_T *C = (const real_T *) mxGetData(PARAM_DEF1(S));
    const real_T *m = (const real_T *) mxGetData(PARAM_DEF2(S));
    const real_T *delta_t = (const real_T *) mxGetData(PARAM_DEF3(S));
    
    Fun_Outputs_wrapper(u1, y1, K, p_width0, C, p_width1, m, p_width2, delta_t, p_width3);
